<div width="720" >
  <h1 align="left">Consumo de API - Aula Async - Javascript</h1>
  
  <div align="center">
    <table>
      </tr>
            <td>
                <a  href="https://github.com/stebsnusch/basecamp-javascript/tree/main/javascript-assincrono">
                Adaptação da aula  de Stephany Nusch - DIO
            </td>
        <td>
...
<img src="FetchApisAsync.gif" >
  ...
  <h3 align="left"> 
  🚧  Aula assync e fetch API  🚧
  </h3>
  <br>
  <h3 align="left"> Features </h3>
  <div align="left">
    - [x] Back End API - Todo List - Desenvolvida em Python - FastAPI<br>
    - [x] Persistência de dados MongoDB - Atlas<br>
    - [x] Front End HTML, CSS: Aula Stephany Nusch com adaptações<br>
    - [x] Deploy Back End : Vercel 
